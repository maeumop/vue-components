...
<template>
  <div class="select-month">
    <SvgIcon type="mdi" :path="mdiChevronDoubleLeft" @click="changedYear(-1, true)" />
    <SvgIcon type="mdi" :path="mdiChevronLeft" @click="changedMonth(-1, true)" />

    <Selector year :end="props.end" :max="maxYear" :min="minYear" />

    <Selector month :end="props.end" />

    <SvgIcon type="mdi" :path="mdiChevronRight" @click="changedMonth(1, true)" />
    <SvgIcon type="mdi" :path="mdiChevronDoubleRight" @click="changedYear(1, true)" />
  </div>
</template>
