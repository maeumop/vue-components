...
import { mdiCalendarMonth } from '@/assets/svg/iconPath';
import {
  computed,
  nextTick,
  onBeforeMount,
...
<template>
  <div ref="el" :class="['date-picker', { block }]">
    <div class="wrap" @click="toggleCalendar">
      ...
      <div ref="inputArea" :class="['picker-date-text', { error: message, disabled: props.disabled, readonly: props.readonly, active: isShow }]">
        <input
          readonly
          type="text"
