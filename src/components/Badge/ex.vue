      ...
      <div class="container">
        ...
        <section class="example-section">
          ...
          <div class="example-grid">
            ...
            <div class="example-item">
              <Badge text="!" color="danger">
                <button class="demo-button">중요</button>
              </Badge>
              <span class="example-label">위험 뱃지</span>
            </div>
          </div>
        </section>
          ...
          <div class="example-grid">
            <div class="example-item">
              <Badge text="5" position="left">
                <button class="demo-button">좌측 상단</button>
              </Badge>
        ...
        <section class="example-section">
          ...
          <div class="example-grid">
            ...
            <div class="example-item">
              <Badge large icon="mdi:heart" color="danger">
                <button class="demo-button">좋아요</button>
              </Badge>
        ...
        <section class="example-section">
          ...
          <div class="example-grid">
            <div class="example-item">
              <Badge text="3" color="danger" position="bottom-right">
